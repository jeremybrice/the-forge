...
| 2026-03-04 | Fix outlook-forge config bar reading wrong key (sources vs channels) | outlook-forge, forge-shell | [design](plans/2026-03-04-outlook-forge-config-field-fix-design.md), [impl](plans/2026-03-04-outlook-forge-config-field-fix.md) |
| 2026-03-04 | Make harvest/transcript infra plugin-agnostic (was hardcoded for slack-forge) | outlook-forge, forge-lib, forge-shell | [design](plans/2026-03-04-outlook-forge-fixes-design.md), [impl](plans/2026-03-04-outlook-forge-fixes-implementation.md) |
| 2026-03-03 | New plugin for extracting Outlook calendar/email context via Chrome automation | outlook-forge | [design](plans/2026-03-03-outlook-forge-design.md), [impl](plans/2026-03-03-outlook-forge-implementation.md) |
...
| 2026-03-03 | CSS overflow fix and SlackForge filter toggle lifecycle bug | forge-shell | [fix](plans/2026-03-03-forge-shell-sidebar-scroll-filter-fix.md) |
| 2026-03-02 | Fix action_items missing from task harvester; fix digest content ordering | slack-forge | [fix](plans/2026-03-02-pr15-cr-fixes.md) |
...
| 2026-02-28 | Shore up quality drift in task harvests and JIRA digests | slack-forge | [design](plans/2026-02-28-harvest-output-consistency.md) |
...
| 2026-02-19 | Reduce JIRA bot transcript size by 40-60% via Python cleanup utility | slack-forge, forge-lib | [design](plans/2026-02-19-jira-transcript-cleanup-design.md), [impl](plans/2026-02-19-jira-transcript-cleanup.md) |
| 2026-02-17 | Slack intelligence pipeline with split execution model (MCP scan + local harvest) | slack-forge | [design](plans/2026-02-17-slack-forge-design.md), [impl](plans/2026-02-17-slack-forge-implementation.md) |
| 2026-02-17 | Validate all 6 plugins follow forge-lib compliance rules | repo-wide | [audit](plans/2026-02-17-marketplace-standardization-audit.md), [fixes](plans/2026-02-17-marketplace-standardization-fixes.md) |
